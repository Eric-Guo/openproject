...
@Component({
  selector: 'op-in-app-inbox-actors-line',
  templateUrl: './in-app-inbox-actors-line.component.html',
  styleUrls: ['./in-app-inbox-actors-line.component.sass'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class InAppInboxActorsLineComponent implements OnInit {
