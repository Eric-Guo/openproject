...
@Component({
  selector: 'op-in-app-inbox-date-alert',
  templateUrl: './in-app-inbox-date-alert.component.html',
  styleUrls: ['./in-app-inbox-date-alert.component.sass'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class InAppInboxDateAlertComponent implements OnInit {
