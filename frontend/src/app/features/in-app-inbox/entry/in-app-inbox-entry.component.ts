...
@Component({
  selector: 'op-in-app-inbox-entry',
  templateUrl: './in-app-inbox-entry.component.html',
  styleUrls: ['./in-app-inbox-entry.component.sass'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class InAppInboxEntryComponent implements OnInit {
