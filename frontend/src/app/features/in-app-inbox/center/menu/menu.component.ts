...
import { IInboxPageQueryParameters } from '../../in-app-inbox.routes';
import { IaiMenuService } from './state/iai-menu.service';
import { BannersService } from 'core-app/core/enterprise/banners.service';

export const iaiMenuSelector = 'op-iai-menu';

const getUiLinkForFilters = (filters:IInboxPageQueryParameters = {}) => ({
  uiSref: 'inbox.center.show',
  uiParams: filters,
});

@Component({
  selector: iaiMenuSelector,
  templateUrl: './menu.component.html',
  styleUrls: ['./menu.component.sass'],
  providers: [IaiMenuService],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IaiMenuComponent implements OnInit {
  ...
  notificationsByProject$ = this.iaiMenuService.notificationsByProject$.pipe(
    map((items) => items
      .map((item) => ({
        ...item,
  ...
  notificationsByReason$ = this.iaiMenuService.notificationsByReason$.pipe(
  ...
  constructor(
    ...
    readonly iaiMenuService:IaiMenuService,
    readonly state:StateService,
    readonly bannersService:BannersService,
  ) { }

  ngOnInit():void {
    this.iaiMenuService.reload();
  }
