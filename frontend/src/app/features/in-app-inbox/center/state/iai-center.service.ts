...
export class IaiCenterService extends UntilDestroyedMixin {
  ...
  readonly store = new IaiCenterStore();
  ...
  get params():ApiV3ListParameters {
    ...
    const hasProject = state.filters.projectId;
    return {
      ...state.params,
      filters: [
        ...IAI_FACET_FILTERS[state.activeFacet],
        ...(
          hasFilters
  ...
  setFacet(facet:InAppInboxFacet):void {
