...
@Component({
  selector: 'op-in-app-inbox-center',
  templateUrl: './in-app-inbox-center.component.html',
  styleUrls: ['./in-app-inbox-center.component.sass'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InAppInboxCenterComponent implements OnInit {
  ...
  constructor(
    ...
    readonly storeService:IaiCenterService,
    readonly bellService:IaiBellService,
