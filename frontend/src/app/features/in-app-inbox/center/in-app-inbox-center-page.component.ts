...
import { InboxSettingsButtonComponent } from 'core-app/features/in-app-inbox/center/toolbar/settings/inbox-settings-button.component';
import { ActivateFacetButtonComponent } from 'core-app/features/in-app-inbox/center/toolbar/facet/activate-facet-button.component';
...
export class InAppInboxCenterPageComponent extends UntilDestroyedMixin implements OnInit, OnDestroy {
  text = {
    title: this.I18n.t('js.inbox.title'),
  };
  ...
  toolbarButtonComponents:ToolbarButtonComponentDefinition[] = [
    ...
    {
      component: InboxSettingsButtonComponent,
  ...
  private setInitialHtmlTitle():void {
    ...
    // Prepend "Inbox" if only the application name is shown
