...
RSpec.describe "API v3 file links resource" do
  ...
  describe "DELETE /api/v3/file_links/:file_link_id/origin" do
    ...
    let(:file_info_query) { class_double(Storages::Adapters::Providers::Nextcloud::Queries::FileInfoQuery) }
    let(:delete_file_command) { class_double(Storages::Adapters::Providers::Nextcloud::Commands::DeleteFileCommand) }
