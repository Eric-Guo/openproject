    ...
    def make_origin_data(model)
      {
        ...
        location: model.origin_location,
        locationName: model.origin_location_name,
    ...
    def parse_origin_data(origin_data)
      {
        ...
        origin_location: origin_data["location"],
        origin_location_name: origin_data["locationName"],
